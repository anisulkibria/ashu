...
?>
<!DOCTYPE html>
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:website="http://ogp.me/ns/website" lang="en-US" itemscope="" itemtype="http://schema.org/WebPage" class="yui3-js-enabled js flexbox canvas canvastext webgl no-touch hashchange history draganddrop rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms no-csstransforms3d csstransitions video audio svg inlinesvg svgclippaths no-window-orientation wf-proximanova-n1-active wf-proximanova-n9-active wf-proximanova-i6-active wf-proximanova-i4-active wf-proximanova-i3-active wf-proximanova-n3-active wf-proximanova-n6-active wf-proximanova-n7-active wf-proximanova-n4-active wf-proximanova-n8-active wf-proximanova-i9-active wf-proximanova-i7-active wf-proximanova-i8-active wf-active" style="" id="yui_3_17_2_1_1530175745063_72"><div id="yui3-css-stamp" style="position: absolute !important; visibility: hidden !important"></div><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<div class="form-wrapper">
  ...
  <div class="form-inner-wrapper">
    ...
    <form autocomplete="on" action="https://sarahlichang.squarespace.com/" method="POST" onsubmit="
      return (function(form) {
        Y.use(&#39;squarespace-form-submit&#39;, &#39;node&#39;, function(Y){
          (new Y.Squarespace.FormSubmit({
            formNode: Y.Node(form)
          })).submit(&#39;52a00e0ae4b01fb98657b9ef&#39;, &#39;&#39;, &#39;contactBlock&#39;);
        });
        return false;
      })(this)" data-form-id="52a00e0ae4b01fb98657b9ef">
    ...
    <div id="contactInfo">
      <div class="contact-inner-wrapper contact-info-inner-wrapper" style="margin-top: 238px;">

        <div class="map-image"><a href="http://maps.google.com/maps?q=40.7143528,-74.0059731" target="_blank" title="View map in new window" data-latitude="40.7143528" data-longitude="-74.0059731" data-zoom="12.0"></a></div>
        ...
        <div class="address-phone-email">
              ...
              <p class="email"><a href="mailto:slc2173@columbia.edu">slc2173@columbia.edu</a></p>
            
            
              <div class="site-description"><p>Ashfaque Ahmed | Ashfaque Abir</p></div>
...
wp_nav_menu( array(
 ...
 ?>
    ...
    <div class="outer-wrapper nav-open" id="yui_3_17_2_1_1530175745063_71">
      <div class="wrapper cf" id="yui_3_17_2_1_1530175745063_70">
        <div id="mobile-header">
          ...
          --><div class="info-email-wrapper">
            ...
            <div id="search-mobile">
              <a class="icon-search" href="http://www.ashfaqueabir.com/search" data-source="template"><span class="icon-text">Search</span></a>
            </div>
          </div>
        </div>
        <header id="header">
...
<?php wp_nav_menu( array( 'theme_location' => 'main-menu' ) ); ?>
        ...
        <div class="content-inner-wrapper" id="yui_3_17_2_1_1530175745063_69" style="margin-top: 233px;">
          <div class="collection-title-desc" data-collection-id="52a01aa4e4b0d7c82c6184da" data-edit-main-image="Banner">
            <div class="collection-title-basic"><h1 class="page-title">About</h1></div>
            
          </div>
            <div class="main-content-wrapper" data-content-field="main-content" data-collection-id="52a01aa4e4b0d7c82c6184da" data-edit-main-image="Banner" id="yui_3_17_2_1_1530175745063_68">
